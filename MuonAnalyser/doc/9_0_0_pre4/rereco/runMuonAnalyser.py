...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring(
      #'file:/pnfs/user/jlee/pfmuon/src/22811.0_TenMuExtendedE_0_200+TenMuExtendedE_0_200_pythia8_2023D4Timing_GenSimHLBeamSpotFull+DigiFullTrigger_2023D4Timing+RecoFullGlobal_2023D4Timing+HARVESTFullGlobal_2023D4Timing/step3.root'
      #'file:step3.root'
    ),
...
dir = os.environ["CMSSW_BASE"]+'/src/MuonPerformance/MuonAnalyser/doc/9_0_0_pre4/ZMM_PU0_pre4_fixed01'
filelst = open(dir+".txt", "r")
#filelst = open(dir+"pu200.txt", "r")
process.source.fileNames = filelst.readlines()

process.TFileService = cms.Service("TFileService",fileName = cms.string("out_ZMMPU0.root"))
